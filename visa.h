...
#pragma EnableLibraryRuntimeChecking
	...
	typedef ViStatus(_VI_FUNCH _VI_PTR ViHndlr)(ViSession vi,
		ViEventType eventType, ViEvent event, ViAddr userHandle);
	...
	ViStatus _VI_FUNC viParseRsrcEx(ViSession rmSesn, ViRsrc rsrcName,
		ViPUInt16 intfType, ViPUInt16 intfNum, ViChar _VI_FAR rsrcClass[],
		ViChar _VI_FAR expandedUnaliasedName[], ViChar _VI_FAR aliasIfExists[]);
	...
	ViStatus _VI_FUNC viLock(ViSession vi, ViAccessMode lockType,
		ViUInt32 timeout, ViKeyId requestedKey, ViChar _VI_FAR accessKey[]);
	...
	ViStatus _VI_FUNC viWrite(ViSession vi, ViBuf buf, ViUInt32 cnt,
		ViPUInt32 retCnt);
	...
	ViStatus _VI_FUNC viVPrintf(ViSession vi, ViString writeFmt,
		ViVAList params);
	ViStatus _VI_FUNCC viSPrintf(ViSession vi, ViPBuf buf,
		ViString writeFmt, ...);
	...
	ViStatus _VI_FUNCC viQueryf(ViSession vi, ViString writeFmt,
		ViString readFmt, ...);
	ViStatus _VI_FUNC viVQueryf(ViSession vi, ViString writeFmt,
	...
	ViStatus _VI_FUNC viMoveIn8(ViSession vi, ViUInt16 space,
	...
	ViStatus _VI_FUNC viMove(ViSession vi, ViUInt16 srcSpace,
		...
		ViBusAddress destOffset, ViUInt16 destWidth, ViBusSize srcLength);
	...
	ViStatus _VI_FUNC viMoveEx(ViSession vi, ViUInt16 srcSpace,
		ViBusAddress64 srcOffset, ViUInt16 srcWidth, ViUInt16 destSpace,
		ViBusAddress64 destOffset, ViUInt16 destWidth, ViBusSize srcLength);
	...
	ViStatus _VI_FUNC viMapAddress(ViSession vi, ViUInt16 mapSpace,
		ViBusAddress mapOffset, ViBusSize mapSize, ViBoolean access,
	...
	ViStatus _VI_FUNC viMapAddressEx(ViSession vi, ViUInt16 mapSpace,
		ViBusAddress64 mapOffset, ViBusSize mapSize, ViBoolean access,
		ViAddr suggested, ViPAddr address);
#endif
	...
	ViStatus _VI_FUNC viAssertIntrSignal(ViSession vi, ViInt16 mode,
		ViUInt32 statusID);
	ViStatus _VI_FUNC viMapTrigger(ViSession vi, ViInt16 trigSrc,
	...
	ViStatus _VI_FUNC viPxiReserveTriggers(ViSession vi, ViInt16 cnt,
		ViAInt16 trigBuses, ViAInt16 trigLines, ViPInt16 failureIndex);
...
#define VI_VXI_DEV_CMD_TYPE_32      (32)
	...
	ViStatus _VI_FUNC viVxiServantResponse(ViSession vi, ViInt16 mode,
		ViUInt32 resp);
