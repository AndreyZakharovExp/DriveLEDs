...
#define CHANNEL_4	   	3
	...
	/* =============================================================================
	 Global functions
	 ============================================================================= */
	ViStatus _VI_FUNC TLDC4100_init(ViRsrc rsrcName, ViBoolean id_query,
	...
	ViStatus _VI_FUNC TLDC4100_self_test(ViSession vi, ViInt16 *test_result,
	...
	ViStatus _VI_FUNC TLDC4100_error_query(ViSession vi, ViInt32 *error_code,
		ViChar _VI_FAR error_message[]);

	ViStatus _VI_FUNC TLDC4100_error_message(ViSession vi, ViStatus status_code,
		ViChar _VI_FAR message[]);

	ViStatus _VI_FUNC TLDC4100_identificationQuery(ViSession instrumentHandle,
		ViChar _VI_FAR manufacturerName[], ViChar _VI_FAR deviceName[],
	...
	ViStatus _VI_FUNC TLDC4100_getHeadInfo(ViSession instrumentHandle,
		ViInt32 channel, ViChar _VI_FAR serialNumber[], ViChar _VI_FAR name[],
		ViPInt32 type);

	/* ---------------------------------------------------------------------------
	 Set/Get user limit current.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setLimitCurrent(ViSession instrumentHandle,
		ViInt32 channel, ViReal32 currentLimit);
	ViStatus _VI_FUNC TLDC4100_getLimitCurrent(ViSession instrumentHandle,
		ViInt32 channel, ViPReal32 currentLimit);

	/* ---------------------------------------------------------------------------
	 Set/Get maximum current.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setMaxLimit(ViSession instrumentHandle,
		ViInt32 channel, ViReal32 maximumCurrentLimit);
	ViStatus _VI_FUNC TLDC4100_getMaxLimit(ViSession instrumentHandle,
		ViInt32 channel, ViPReal32 maximumCurrentLimit);

	/* ---------------------------------------------------------------------------
	 Set/Get operation mode.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setOperationMode(ViSession instrumentHandle,
		ViInt32 operationMode);
	ViStatus _VI_FUNC TLDC4100_getOperationMode(ViSession instrumentHandle,
		ViPInt32 operationMode);

	/* ---------------------------------------------------------------------------
	 Set/Get LED output.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setLedOnOff(ViSession instrumentHandle,
		ViInt32 channel, ViBoolean LEDOnOff);
	ViStatus _VI_FUNC TLDC4100_getLedOnOff(ViSession instrumentHandle,
		ViInt32 channel, ViPBoolean LEDOutputState);

	/* ---------------------------------------------------------------------------
	 Set/Get selection mode.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setSelectionMode(ViSession instrumentHandle,
		ViInt32 selectionMode);
	ViStatus _VI_FUNC TLDC4100_getSelectionMode(ViSession instrumentHandle,
		ViPInt32 selectionMode);

	/* ---------------------------------------------------------------------------
	 Set/Get constant current.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setConstCurrent(ViSession instrumentHandle,
		ViInt32 channel, ViReal32 constantCurrent);
	ViStatus _VI_FUNC TLDC4100_getConstCurrent(ViSession instrumentHandle,
		ViInt32 channel, ViPReal32 constantCurrent);

	/* ---------------------------------------------------------------------------
	 Set/Get percental brightness current.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setPercentalBrightness
		(ViSession instrumentHandle, ViInt32 channel, ViReal32 brightness);
	ViStatus _VI_FUNC TLDC4100_getPercentalBrightness
		(ViSession instrumentHandle, ViInt32 channel, ViPReal32 brightness);

	/* ---------------------------------------------------------------------------
	 Set/Get the display brightness.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_setDispBright(ViSession instrumentHandle,
		ViInt32 displayBrightness);
	ViStatus _VI_FUNC TLDC4100_getDispBright(ViSession instrumentHandle,
		ViPInt32 displayBrightness);

	/* ---------------------------------------------------------------------------
	 Get the status register.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_getStatusRegister(ViSession instrumentHandle,
		ViPInt32 statusRegister);

	/* ---------------------------------------------------------------------------
	 Get the wavelength information.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_getWavelength(ViSession instrumentHandle,
		ViInt32 channel, ViPReal32 wavelength);

	/* ---------------------------------------------------------------------------
	 Get the forward bias.
	 --------------------------------------------------------------------------- */
	ViStatus _VI_FUNC TLDC4100_getForwardBias(ViSession instrumentHandle,
		ViInt32 channel, ViPReal32 forwardBias);
